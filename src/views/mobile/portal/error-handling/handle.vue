      ...
      <template v-else-if="equipment">
        ...
        <div class="bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 rounded-2xl p-4 shadow-3xs space-y-2">
          <div class="flex items-center justify-between">
            <span class="text-[10px] font-bold uppercase text-rose-500 tracking-wider">Thiết Bị Đã Quét QR</span>
            <Button
              type="link"
              size="small"
              class="p-0 h-auto text-xs text-slate-400 hover:text-rose-600"
              @click="handleBack"
            >
              Quét lại
            </Button>
          ...
          <div>
            ...
            <div class="flex flex-wrap items-center gap-2 mt-1">
              ...
              <span v-if="equipment.equipment_category?.name" class="text-xs bg-rose-50 dark:bg-rose-950/40 px-2 py-0.5 rounded-md text-rose-600 dark:text-rose-400">
        ...
        <div class="bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 rounded-2xl p-4 space-y-4 shadow-3xs">
          ...
          <div class="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-zinc-800">
            <label class="text-xs font-bold text-slate-700 dark:text-zinc-300">
              Chọn loại lỗi đã khắc phục <span class="text-red-500">*</span>
            </label>
          </div>
